...
var defaultRoleAssumers = require('./defaultRoleAssumers-f1274937.js');
var configurations = require('./configurations-a8a5ec49.js');
require('http2');
require('stream');
var serdePlugin = require('./serdePlugin-96c19d04.js');
require('url');
require('buffer');
require('http');
require('fs');
...
var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(httpRequest.__assign({ signingService: "sqs" }, regionInfo));
};
...
var ClientSharedValues = {
    ...
    serviceId: "SQS",
    urlParser: defaultRoleAssumers.parseUrl,
};

/**
 * @internal
 */
var ClientDefaultValues = httpRequest.__assign(httpRequest.__assign({}, ClientSharedValues), { runtime: "node", base64Decoder: defaultRoleAssumers.fromBase64, base64Encoder: defaultRoleAssumers.toBase64, bodyLengthChecker: defaultRoleAssumers.calculateBodyLength, credentialDefaultProvider: defaultRoleAssumers.decorateDefaultCredentialProvider(defaultRoleAssumers.defaultProvider), defaultUserAgentProvider: defaultRoleAssumers.defaultUserAgent({
        serviceId: ClientSharedValues.serviceId,
        clientVersion: packageInfo.version,
    }), maxAttempts: defaultRoleAssumers.loadConfig(configurations.NODE_MAX_ATTEMPT_CONFIG_OPTIONS), md5: defaultRoleAssumers.Hash.bind(null, "md5"), region: defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_REGION_CONFIG_OPTIONS, defaultRoleAssumers.NODE_REGION_CONFIG_FILE_OPTIONS), requestHandler: new defaultRoleAssumers.NodeHttpHandler(), retryModeProvider: defaultRoleAssumers.loadConfig(configurations.NODE_RETRY_MODE_CONFIG_OPTIONS), sha256: defaultRoleAssumers.Hash.bind(null, "sha256"), streamCollector: defaultRoleAssumers.streamCollector, utf8Decoder: defaultRoleAssumers.fromUtf8, utf8Encoder: defaultRoleAssumers.toUtf8 });
...
var SQSClient = /** @class */ (function (_super) {
    httpRequest.__extends(SQSClient, _super);
    function SQSClient(configuration) {
        var _this = this;
        var _config_0 = httpRequest.__assign(httpRequest.__assign({}, ClientDefaultValues), configuration);
        ...
        var _config_3 = configurations.resolveRetryConfig(_config_2);
        ...
        _this.middlewareStack.use(configurations.getRetryPlugin(_this.config));
...
(function (AddPermissionRequest) {
     ...
     * @internal
     */
    AddPermissionRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (OverLimit) {
     ...
     * @internal
     */
    OverLimit.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ChangeMessageVisibilityRequest) {
     ...
     * @internal
     */
    ChangeMessageVisibilityRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (MessageNotInflight) {
     ...
     * @internal
     */
    MessageNotInflight.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ReceiptHandleIsInvalid) {
     ...
     * @internal
     */
    ReceiptHandleIsInvalid.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (BatchEntryIdsNotDistinct) {
     ...
     * @internal
     */
    BatchEntryIdsNotDistinct.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ChangeMessageVisibilityBatchRequestEntry) {
     ...
     * @internal
     */
    ChangeMessageVisibilityBatchRequestEntry.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ChangeMessageVisibilityBatchRequest) {
     ...
     * @internal
     */
    ChangeMessageVisibilityBatchRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (BatchResultErrorEntry) {
     ...
     * @internal
     */
    BatchResultErrorEntry.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ChangeMessageVisibilityBatchResultEntry) {
     ...
     * @internal
     */
    ChangeMessageVisibilityBatchResultEntry.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ChangeMessageVisibilityBatchResult) {
     ...
     * @internal
     */
    ChangeMessageVisibilityBatchResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (EmptyBatchRequest) {
     ...
     * @internal
     */
    EmptyBatchRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (InvalidBatchEntryId) {
     ...
     * @internal
     */
    InvalidBatchEntryId.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (TooManyEntriesInBatchRequest) {
     ...
     * @internal
     */
    TooManyEntriesInBatchRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (CreateQueueRequest) {
     ...
     * @internal
     */
    CreateQueueRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (CreateQueueResult) {
     ...
     * @internal
     */
    CreateQueueResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (QueueDeletedRecently) {
     ...
     * @internal
     */
    QueueDeletedRecently.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (QueueNameExists) {
     ...
     * @internal
     */
    QueueNameExists.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (DeleteMessageRequest) {
     ...
     * @internal
     */
    DeleteMessageRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (InvalidIdFormat) {
     ...
     * @internal
     */
    InvalidIdFormat.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (DeleteMessageBatchRequestEntry) {
     ...
     * @internal
     */
    DeleteMessageBatchRequestEntry.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (DeleteMessageBatchRequest) {
     ...
     * @internal
     */
    DeleteMessageBatchRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (DeleteMessageBatchResultEntry) {
     ...
     * @internal
     */
    DeleteMessageBatchResultEntry.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (DeleteMessageBatchResult) {
     ...
     * @internal
     */
    DeleteMessageBatchResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (DeleteQueueRequest) {
     ...
     * @internal
     */
    DeleteQueueRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (GetQueueAttributesRequest) {
     ...
     * @internal
     */
    GetQueueAttributesRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (GetQueueAttributesResult) {
     ...
     * @internal
     */
    GetQueueAttributesResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (InvalidAttributeName) {
     ...
     * @internal
     */
    InvalidAttributeName.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (GetQueueUrlRequest) {
     ...
     * @internal
     */
    GetQueueUrlRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (GetQueueUrlResult) {
     ...
     * @internal
     */
    GetQueueUrlResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (QueueDoesNotExist) {
     ...
     * @internal
     */
    QueueDoesNotExist.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ListDeadLetterSourceQueuesRequest) {
     ...
     * @internal
     */
    ListDeadLetterSourceQueuesRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ListDeadLetterSourceQueuesResult) {
     ...
     * @internal
     */
    ListDeadLetterSourceQueuesResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ListQueuesRequest) {
     ...
     * @internal
     */
    ListQueuesRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ListQueuesResult) {
     ...
     * @internal
     */
    ListQueuesResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ListQueueTagsRequest) {
     ...
     * @internal
     */
    ListQueueTagsRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ListQueueTagsResult) {
     ...
     * @internal
     */
    ListQueueTagsResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (PurgeQueueInProgress) {
     ...
     * @internal
     */
    PurgeQueueInProgress.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (PurgeQueueRequest) {
     ...
     * @internal
     */
    PurgeQueueRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ReceiveMessageRequest) {
     ...
     * @internal
     */
    ReceiveMessageRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (MessageAttributeValue) {
     ...
     * @internal
     */
    MessageAttributeValue.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (Message) {
     ...
     * @internal
     */
    Message.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (ReceiveMessageResult) {
     ...
     * @internal
     */
    ReceiveMessageResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (RemovePermissionRequest) {
     ...
     * @internal
     */
    RemovePermissionRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (InvalidMessageContents) {
     ...
     * @internal
     */
    InvalidMessageContents.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (MessageSystemAttributeValue) {
     ...
     * @internal
     */
    MessageSystemAttributeValue.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (SendMessageRequest) {
     ...
     * @internal
     */
    SendMessageRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (SendMessageResult) {
     ...
     * @internal
     */
    SendMessageResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (UnsupportedOperation) {
     ...
     * @internal
     */
    UnsupportedOperation.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (BatchRequestTooLong) {
     ...
     * @internal
     */
    BatchRequestTooLong.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (SendMessageBatchRequestEntry) {
     ...
     * @internal
     */
    SendMessageBatchRequestEntry.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (SendMessageBatchRequest) {
     ...
     * @internal
     */
    SendMessageBatchRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (SendMessageBatchResultEntry) {
     ...
     * @internal
     */
    SendMessageBatchResultEntry.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (SendMessageBatchResult) {
     ...
     * @internal
     */
    SendMessageBatchResult.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (SetQueueAttributesRequest) {
     ...
     * @internal
     */
    SetQueueAttributesRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (TagQueueRequest) {
     ...
     * @internal
     */
    TagQueueRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
...
(function (UntagQueueRequest) {
     ...
     * @internal
     */
    UntagQueueRequest.filterSensitiveLog = function (obj) { return (httpRequest.__assign({}, obj)); };
})(exports.UntagQueueRequest || (exports.UntagQueueRequest = {}));

var serializeAws_queryAddPermissionCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryAddPermissionRequest(input)), { Action: "AddPermission", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryChangeMessageVisibilityCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryChangeMessageVisibilityRequest(input)), { Action: "ChangeMessageVisibility", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryChangeMessageVisibilityBatchCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryChangeMessageVisibilityBatchRequest(input, context)), { Action: "ChangeMessageVisibilityBatch", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryCreateQueueCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryCreateQueueRequest(input)), { Action: "CreateQueue", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryDeleteMessageCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryDeleteMessageRequest(input)), { Action: "DeleteMessage", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryDeleteMessageBatchCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryDeleteMessageBatchRequest(input, context)), { Action: "DeleteMessageBatch", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryDeleteQueueCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryDeleteQueueRequest(input)), { Action: "DeleteQueue", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryGetQueueAttributesCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryGetQueueAttributesRequest(input)), { Action: "GetQueueAttributes", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryGetQueueUrlCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryGetQueueUrlRequest(input)), { Action: "GetQueueUrl", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryListDeadLetterSourceQueuesCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryListDeadLetterSourceQueuesRequest(input)), { Action: "ListDeadLetterSourceQueues", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryListQueuesCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryListQueuesRequest(input)), { Action: "ListQueues", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryListQueueTagsCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryListQueueTagsRequest(input)), { Action: "ListQueueTags", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryPurgeQueueCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryPurgeQueueRequest(input)), { Action: "PurgeQueue", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryReceiveMessageCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryReceiveMessageRequest(input)), { Action: "ReceiveMessage", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryRemovePermissionCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryRemovePermissionRequest(input)), { Action: "RemovePermission", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_querySendMessageCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_querySendMessageRequest(input, context)), { Action: "SendMessage", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_querySendMessageBatchCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_querySendMessageBatchRequest(input, context)), { Action: "SendMessageBatch", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_querySetQueueAttributesCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_querySetQueueAttributesRequest(input)), { Action: "SetQueueAttributes", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryTagQueueCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryTagQueueRequest(input)), { Action: "TagQueue", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var serializeAws_queryUntagQueueCommand = function (input, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return httpRequest.__generator(this, function (_a) {
        headers = {
            "content-type": "application/x-www-form-urlencoded",
        };
        body = buildFormUrlencodedString(httpRequest.__assign(httpRequest.__assign({}, serializeAws_queryUntagQueueRequest(input)), { Action: "UntagQueue", Version: "2012-11-05" }));
        return [2 /*return*/, buildHttpRpcRequest(context, headers, "/", undefined, body)];
    });
}); };
var deserializeAws_queryAddPermissionCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryAddPermissionCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, parsedBody, message;
    var _d;
    return httpRequest.__generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                _a = [httpRequest.__assign({}, output)];
                _d = {};
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                parsedOutput = httpRequest.__assign.apply(void 0, _a.concat([(_d.body = _e.sent(), _d)]));
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryOverLimitResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_e.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 5];
            case 4:
                parsedBody = parsedOutput.body;
                errorCode = parsedBody.Error.code || parsedBody.Error.Code || errorCode;
                response = httpRequest.__assign(httpRequest.__assign({}, parsedBody.Error), { name: "" + errorCode, message: parsedBody.Error.message || parsedBody.Error.Message || errorCode, $fault: "client", $metadata: deserializeMetadata(output) });
                _e.label = 5;
            case 5:
...
var deserializeAws_queryChangeMessageVisibilityCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryChangeMessageVisibilityCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    ...
    return httpRequest.__generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                parsedOutput = httpRequest.__assign.apply(void 0, _a.concat([(_e.body = _f.sent(), _e)]));
                errorCode = "UnknownError";
                errorCode = loadQueryErrorCode(output, parsedOutput.body);
                _b = errorCode;
                switch (_b) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryMessageNotInflightResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 4:
                _d = [{}];
                return [4 /*yield*/, deserializeAws_queryReceiptHandleIsInvalidResponse(parsedOutput)];
            case 5:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _d.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 6:
                parsedBody = parsedOutput.body;
                errorCode = parsedBody.Error.code || parsedBody.Error.Code || errorCode;
...
var deserializeAws_queryChangeMessageVisibilityBatchCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    ...
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryChangeMessageVisibilityBatchResult(data.ChangeMessageVisibilityBatchResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryChangeMessageVisibilityBatchCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, _e, _f, parsedBody, message;
    var _g;
    return httpRequest.__generator(this, function (_h) {
        switch (_h.label) {
            case 0:
                _a = [httpRequest.__assign({}, output)];
                _g = {};
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                parsedOutput = httpRequest.__assign.apply(void 0, _a.concat([(_g.body = _h.sent(), _g)]));
                errorCode = "UnknownError";
                errorCode = loadQueryErrorCode(output, parsedOutput.body);
                _b = errorCode;
                switch (_b) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryBatchEntryIdsNotDistinctResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_h.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 11];
            case 4:
                _d = [{}];
                return [4 /*yield*/, deserializeAws_queryEmptyBatchRequestResponse(parsedOutput)];
            case 5:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _d.concat([(_h.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 11];
            case 6:
                _e = [{}];
                return [4 /*yield*/, deserializeAws_queryInvalidBatchEntryIdResponse(parsedOutput)];
            case 7:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _e.concat([(_h.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 11];
            case 8:
                _f = [{}];
                return [4 /*yield*/, deserializeAws_queryTooManyEntriesInBatchRequestResponse(parsedOutput)];
            case 9:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _f.concat([(_h.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 11];
            case 10:
                parsedBody = parsedOutput.body;
                errorCode = parsedBody.Error.code || parsedBody.Error.Code || errorCode;
...
var deserializeAws_queryCreateQueueCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryCreateQueueResult(data.CreateQueueResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryCreateQueueCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, parsedBody, message;
    var _e;
    return httpRequest.__generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryQueueDeletedRecentlyResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 4:
                _d = [{}];
                return [4 /*yield*/, deserializeAws_queryQueueNameExistsResponse(parsedOutput)];
            case 5:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _d.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 6:
...
var deserializeAws_queryDeleteMessageCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryDeleteMessageCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, parsedBody, message;
    var _e;
    return httpRequest.__generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryInvalidIdFormatResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 4:
...
var deserializeAws_queryDeleteMessageBatchCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryDeleteMessageBatchResult(data.DeleteMessageBatchResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryDeleteMessageBatchCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, _e, _f, parsedBody, message;
    var _g;
    return httpRequest.__generator(this, function (_h) {
        switch (_h.label) {
...
var deserializeAws_queryDeleteQueueCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryDeleteQueueCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    ...
    return httpRequest.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                parsedOutput = httpRequest.__assign.apply(void 0, _a.concat([(_b.body = _c.sent(), _b)]));
                errorCode = "UnknownError";
                errorCode = loadQueryErrorCode(output, parsedOutput.body);
                switch (errorCode) {
                    default:
...
var deserializeAws_queryGetQueueAttributesCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryGetQueueAttributesResult(data.GetQueueAttributesResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryGetQueueAttributesCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, parsedBody, message;
    var _d;
    return httpRequest.__generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryInvalidAttributeNameResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_e.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 5];
            case 4:
...
var deserializeAws_queryGetQueueUrlCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryGetQueueUrlResult(data.GetQueueUrlResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryGetQueueUrlCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, parsedBody, message;
    var _d;
    return httpRequest.__generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryQueueDoesNotExistResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_e.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 5];
            case 4:
...
var deserializeAws_queryListDeadLetterSourceQueuesCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryListDeadLetterSourceQueuesResult(data.ListDeadLetterSourceQueuesResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryListDeadLetterSourceQueuesCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, parsedBody, message;
    var _d;
    return httpRequest.__generator(this, function (_e) {
        switch (_e.label) {
...
var deserializeAws_queryListQueuesCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryListQueuesResult(data.ListQueuesResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryListQueuesCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, parsedBody, message;
    var _b;
    return httpRequest.__generator(this, function (_c) {
        switch (_c.label) {
...
var deserializeAws_queryListQueueTagsCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_queryListQueueTagsResult(data.ListQueueTagsResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_queryListQueueTagsCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, parsedBody, message;
    var _b;
    return httpRequest.__generator(this, function (_c) {
        switch (_c.label) {
...
var deserializeAws_queryPurgeQueueCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryPurgeQueueCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, parsedBody, message;
    var _e;
    return httpRequest.__generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryPurgeQueueInProgressResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 4:
...
var deserializeAws_queryReceiveMessageCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryReceiveMessageCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, parsedBody, message;
    var _d;
    return httpRequest.__generator(this, function (_e) {
        switch (_e.label) {
...
var deserializeAws_queryRemovePermissionCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryRemovePermissionCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, parsedBody, message;
    var _b;
    return httpRequest.__generator(this, function (_c) {
        switch (_c.label) {
...
var deserializeAws_querySendMessageCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_querySendMessageCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, parsedBody, message;
    var _e;
    return httpRequest.__generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_queryInvalidMessageContentsResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 4:
                _d = [{}];
                return [4 /*yield*/, deserializeAws_queryUnsupportedOperationResponse(parsedOutput)];
            case 5:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _d.concat([(_f.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 7];
            case 6:
...
var deserializeAws_querySendMessageBatchCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                data = _a.sent();
                contents = {};
                contents = deserializeAws_querySendMessageBatchResult(data.SendMessageBatchResult);
                response = httpRequest.__assign({ $metadata: deserializeMetadata(output) }, contents);
                return [2 /*return*/, Promise.resolve(response)];
        }
    });
}); };
var deserializeAws_querySendMessageBatchCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, _e, _f, _g, _h, parsedBody, message;
    var _j;
    return httpRequest.__generator(this, function (_k) {
        switch (_k.label) {
            case 0:
                _a = [httpRequest.__assign({}, output)];
                _j = {};
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                parsedOutput = httpRequest.__assign.apply(void 0, _a.concat([(_j.body = _k.sent(), _j)]));
                errorCode = "UnknownError";
                errorCode = loadQueryErrorCode(output, parsedOutput.body);
                _b = errorCode;
                switch (_b) {
            ...
            case 2:
                ...
                return [4 /*yield*/, deserializeAws_queryBatchEntryIdsNotDistinctResponse(parsedOutput)];
            case 3:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _c.concat([(_k.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 15];
            case 4:
                _d = [{}];
                return [4 /*yield*/, deserializeAws_queryBatchRequestTooLongResponse(parsedOutput)];
            case 5:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _d.concat([(_k.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 15];
            case 6:
                _e = [{}];
                return [4 /*yield*/, deserializeAws_queryEmptyBatchRequestResponse(parsedOutput)];
            case 7:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _e.concat([(_k.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 15];
            case 8:
                _f = [{}];
                return [4 /*yield*/, deserializeAws_queryInvalidBatchEntryIdResponse(parsedOutput)];
            case 9:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _f.concat([(_k.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 15];
            case 10:
                _g = [{}];
                return [4 /*yield*/, deserializeAws_queryTooManyEntriesInBatchRequestResponse(parsedOutput)];
            case 11:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _g.concat([(_k.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 15];
            case 12:
                _h = [{}];
                return [4 /*yield*/, deserializeAws_queryUnsupportedOperationResponse(parsedOutput)];
            case 13:
                response = httpRequest.__assign.apply(void 0, [httpRequest.__assign.apply(void 0, _h.concat([(_k.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 15];
            case 14:
                parsedBody = parsedOutput.body;
                errorCode = parsedBody.Error.code || parsedBody.Error.Code || errorCode;
...
var deserializeAws_querySetQueueAttributesCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_querySetQueueAttributesCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, parsedBody, message;
    var _d;
    return httpRequest.__generator(this, function (_e) {
        switch (_e.label) {
...
var deserializeAws_queryTagQueueCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryTagQueueCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, parsedBody, message;
    var _b;
    return httpRequest.__generator(this, function (_c) {
        switch (_c.label) {
...
var deserializeAws_queryUntagQueueCommand = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var response;
    return httpRequest.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_queryUntagQueueCommandError = function (output, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, parsedBody, message;
    var _b;
    return httpRequest.__generator(this, function (_c) {
        switch (_c.label) {
...
var deserializeAws_queryBatchEntryIdsNotDistinctResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryBatchEntryIdsNotDistinct(body.Error);
        contents = httpRequest.__assign({ name: "BatchEntryIdsNotDistinct", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryBatchRequestTooLongResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryBatchRequestTooLong(body.Error);
        contents = httpRequest.__assign({ name: "BatchRequestTooLong", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryEmptyBatchRequestResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryEmptyBatchRequest(body.Error);
        contents = httpRequest.__assign({ name: "EmptyBatchRequest", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryInvalidAttributeNameResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryInvalidAttributeName(body.Error);
        contents = httpRequest.__assign({ name: "InvalidAttributeName", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryInvalidBatchEntryIdResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryInvalidBatchEntryId(body.Error);
        contents = httpRequest.__assign({ name: "InvalidBatchEntryId", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryInvalidIdFormatResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryInvalidIdFormat(body.Error);
        contents = httpRequest.__assign({ name: "InvalidIdFormat", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryInvalidMessageContentsResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryInvalidMessageContents(body.Error);
        contents = httpRequest.__assign({ name: "InvalidMessageContents", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryMessageNotInflightResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryMessageNotInflight(body.Error);
        contents = httpRequest.__assign({ name: "MessageNotInflight", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryOverLimitResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryOverLimit(body.Error);
        contents = httpRequest.__assign({ name: "OverLimit", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryPurgeQueueInProgressResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryPurgeQueueInProgress(body.Error);
        contents = httpRequest.__assign({ name: "PurgeQueueInProgress", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryQueueDeletedRecentlyResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryQueueDeletedRecently(body.Error);
        contents = httpRequest.__assign({ name: "QueueDeletedRecently", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryQueueDoesNotExistResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryQueueDoesNotExist(body.Error);
        contents = httpRequest.__assign({ name: "QueueDoesNotExist", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryQueueNameExistsResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryQueueNameExists(body.Error);
        contents = httpRequest.__assign({ name: "QueueNameExists", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryReceiptHandleIsInvalidResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryReceiptHandleIsInvalid(body.Error);
        contents = httpRequest.__assign({ name: "ReceiptHandleIsInvalid", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryTooManyEntriesInBatchRequestResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryTooManyEntriesInBatchRequest(body.Error);
        contents = httpRequest.__assign({ name: "TooManyEntriesInBatchRequest", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var deserializeAws_queryUnsupportedOperationResponse = function (parsedOutput, context) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, contents;
    return httpRequest.__generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_queryUnsupportedOperation(body.Error);
        contents = httpRequest.__assign({ name: "UnsupportedOperation", $fault: "client", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
        return [2 /*return*/, contents];
    });
}); };
var serializeAws_queryActionNameList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_1 = httpRequest.__values(input), input_1_1 = input_1.next(); !input_1_1.done; input_1_1 = input_1.next()) {
...
var serializeAws_queryAddPermissionRequest = function (input, context) {
    ...
    if (input.AWSAccountIds !== undefined && input.AWSAccountIds !== null) {
        var memberEntries = serializeAws_queryAWSAccountIdList(input.AWSAccountIds);
        Object.entries(memberEntries).forEach(function (_a) {
            var _b = httpRequest.__read(_a, 2), key = _b[0], value = _b[1];
...
var serializeAws_queryAttributeNameList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_2 = httpRequest.__values(input), input_2_1 = input_2.next(); !input_2_1.done; input_2_1 = input_2.next()) {
...
var serializeAws_queryAWSAccountIdList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_3 = httpRequest.__values(input), input_3_1 = input_3.next(); !input_3_1.done; input_3_1 = input_3.next()) {
...
var serializeAws_queryBinaryList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_4 = httpRequest.__values(input), input_4_1 = input_4.next(); !input_4_1.done; input_4_1 = input_4.next()) {
...
var serializeAws_queryChangeMessageVisibilityBatchRequestEntryList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_5 = httpRequest.__values(input), input_5_1 = input_5.next(); !input_5_1.done; input_5_1 = input_5.next()) {
...
var serializeAws_queryDeleteMessageBatchRequestEntryList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_6 = httpRequest.__values(input), input_6_1 = input_6.next(); !input_6_1.done; input_6_1 = input_6.next()) {
...
var serializeAws_queryMessageAttributeNameList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_7 = httpRequest.__values(input), input_7_1 = input_7.next(); !input_7_1.done; input_7_1 = input_7.next()) {
...
var serializeAws_querySendMessageBatchRequestEntryList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_8 = httpRequest.__values(input), input_8_1 = input_8.next(); !input_8_1.done; input_8_1 = input_8.next()) {
...
var serializeAws_queryStringList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_9 = httpRequest.__values(input), input_9_1 = input_9.next(); !input_9_1.done; input_9_1 = input_9.next()) {
...
var serializeAws_queryTagKeyList = function (input, context) {
    ...
    var counter = 1;
    try {
        for (var input_10 = httpRequest.__values(input), input_10_1 = input_10.next(); !input_10_1.done; input_10_1 = input_10.next()) {
...
var deserializeAws_queryChangeMessageVisibilityBatchResult = function (output, context) {
    ...
    if (output["ChangeMessageVisibilityBatchResultEntry"] !== undefined) {
        contents.Successful = deserializeAws_queryChangeMessageVisibilityBatchResultEntryList(getArrayIfSingleItem(output["ChangeMessageVisibilityBatchResultEntry"]));
    }
...
var deserializeAws_queryDeleteMessageBatchResult = function (output, context) {
    ...
    if (output["DeleteMessageBatchResultEntry"] !== undefined) {
        contents.Successful = deserializeAws_queryDeleteMessageBatchResultEntryList(getArrayIfSingleItem(output["DeleteMessageBatchResultEntry"]));
    }
    if (output.BatchResultErrorEntry === "") {
        contents.Failed = [];
    }
...
var deserializeAws_queryGetQueueAttributesResult = function (output, context) {
    ...
    if (output["Attribute"] !== undefined) {
        contents.Attributes = deserializeAws_queryQueueAttributeMap(getArrayIfSingleItem(output["Attribute"]));
    }
    return contents;
};
...
var deserializeAws_queryListDeadLetterSourceQueuesResult = function (output, context) {
    ...
    if (output["QueueUrl"] !== undefined) {
        contents.queueUrls = deserializeAws_queryQueueUrlList(getArrayIfSingleItem(output["QueueUrl"]));
    }
...
var deserializeAws_queryListQueueTagsResult = function (output, context) {
    ...
    if (output["Tag"] !== undefined) {
        contents.Tags = deserializeAws_queryTagMap(getArrayIfSingleItem(output["Tag"]));
    }
    return contents;
};
...
var deserializeAws_queryMessageBodyAttributeMap = function (output, context) {
    return output.reduce(function (acc, pair) {
        ...
        return httpRequest.__assign(httpRequest.__assign({}, acc), (_a = {}, _a[pair["Name"]] = deserializeAws_queryMessageAttributeValue(pair["Value"], context), _a));
    }, {});
};
...
var deserializeAws_queryMessageSystemAttributeMap = function (output, context) {
    return output.reduce(function (acc, pair) {
        ...
        return httpRequest.__assign(httpRequest.__assign({}, acc), (_a = {}, _a[pair["Name"]] = pair["Value"], _a));
    }, {});
};
...
var deserializeAws_querySendMessageBatchResult = function (output, context) {
    ...
    if (output["SendMessageBatchResultEntry"] !== undefined) {
        contents.Successful = deserializeAws_querySendMessageBatchResultEntryList(getArrayIfSingleItem(output["SendMessageBatchResultEntry"]));
    }
    if (output.BatchResultErrorEntry === "") {
        contents.Failed = [];
    }
...
var deserializeAws_queryTagMap = function (output, context) {
    return output.reduce(function (acc, pair) {
        ...
        return httpRequest.__assign(httpRequest.__assign({}, acc), (_a = {}, _a[pair["Key"]] = pair["Value"], _a));
    }, {});
};
...
var buildHttpRpcRequest = function (context, headers, path, resolvedHostname, body) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
    ...
    return httpRequest.__generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, new httpRequest.HttpRequest(contents)];
        }
    });
}); };
...
var AddPermissionCommand = /** @class */ (function (_super) {
    httpRequest.__extends(AddPermissionCommand, _super);
...
var ChangeMessageVisibilityBatchCommand = /** @class */ (function (_super) {
    httpRequest.__extends(ChangeMessageVisibilityBatchCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var ChangeMessageVisibilityCommand = /** @class */ (function (_super) {
    httpRequest.__extends(ChangeMessageVisibilityCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var CreateQueueCommand = /** @class */ (function (_super) {
    httpRequest.__extends(CreateQueueCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var DeleteMessageBatchCommand = /** @class */ (function (_super) {
    httpRequest.__extends(DeleteMessageBatchCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var DeleteMessageCommand = /** @class */ (function (_super) {
    httpRequest.__extends(DeleteMessageCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var DeleteQueueCommand = /** @class */ (function (_super) {
    httpRequest.__extends(DeleteQueueCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var GetQueueAttributesCommand = /** @class */ (function (_super) {
    httpRequest.__extends(GetQueueAttributesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var GetQueueUrlCommand = /** @class */ (function (_super) {
    httpRequest.__extends(GetQueueUrlCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var ListDeadLetterSourceQueuesCommand = /** @class */ (function (_super) {
    httpRequest.__extends(ListDeadLetterSourceQueuesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var ListQueueTagsCommand = /** @class */ (function (_super) {
    httpRequest.__extends(ListQueueTagsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var ListQueuesCommand = /** @class */ (function (_super) {
    httpRequest.__extends(ListQueuesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var PurgeQueueCommand = /** @class */ (function (_super) {
    httpRequest.__extends(PurgeQueueCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
function receiveMessageMiddleware(options) {
    ...
    return function (next) {
        return function (args) { return httpRequest.__awaiter(_this, void 0, void 0, function () {
            var resp, output, messageIds, _a, _b, message, md5, hash, _c, _d, e_1_1;
            var e_1, _e;
            return httpRequest.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, next(httpRequest.__assign({}, args))];
                    case 1:
                        resp = _f.sent();
                        output = resp.output;
                        messageIds = [];
                    ...
                    case 2:
                        ...
                        _a = httpRequest.__values(output.Messages), _b = _a.next();
                        _f.label = 3;
                    case 3:
...
var sendMessageBatchMiddleware = function (options) {
    return function (next) {
        return function (args) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
            ...
            var e_2, _g, e_1, _h;
            return httpRequest.__generator(this, function (_j) {
                switch (_j.label) {
                    case 0: return [4 /*yield*/, next(httpRequest.__assign({}, args))];
                    case 1:
                        resp = _j.sent();
                        ...
                        if (output.Successful !== undefined) {
                            try {
                                for (_a = httpRequest.__values(output.Successful), _b = _a.next(); !_b.done; _b = _a.next()) {
                                    entry = _b.value;
                    ...
                    case 2:
                        ...
                        _c = httpRequest.__values(args.input.Entries), _d = _c.next();
                        _j.label = 3;
                    case 3:
...
var ReceiveMessageCommand = /** @class */ (function (_super) {
    httpRequest.__extends(ReceiveMessageCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var RemovePermissionCommand = /** @class */ (function (_super) {
    httpRequest.__extends(RemovePermissionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var SendMessageBatchCommand = /** @class */ (function (_super) {
    httpRequest.__extends(SendMessageBatchCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var SendMessageCommand = /** @class */ (function (_super) {
    httpRequest.__extends(SendMessageCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var SetQueueAttributesCommand = /** @class */ (function (_super) {
    httpRequest.__extends(SetQueueAttributesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var TagQueueCommand = /** @class */ (function (_super) {
    httpRequest.__extends(TagQueueCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var UntagQueueCommand = /** @class */ (function (_super) {
    httpRequest.__extends(UntagQueueCommand, _super);
    // Start section: command_properties
    // End section: command_properties
...
var SQS = /** @class */ (function (_super) {
    httpRequest.__extends(SQS, _super);
    function SQS() {
...
var makePagedClientRequest$1 = function (client, input) {
    ...
    return httpRequest.__awaiter(void 0, void 0, void 0, function () {
        return httpRequest.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.send.apply(client, httpRequest.__spreadArray([new ListDeadLetterSourceQueuesCommand(input)], httpRequest.__read(args)))];
                case 1: 
                // @ts-ignore
...
var makePagedRequest$1 = function (client, input) {
    ...
    return httpRequest.__awaiter(void 0, void 0, void 0, function () {
        return httpRequest.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.listDeadLetterSourceQueues.apply(client, httpRequest.__spreadArray([input], httpRequest.__read(args)))];
                case 1: 
                // @ts-ignore
                return [2 /*return*/, _a.sent()];
            }
...
function paginateListDeadLetterSourceQueues(config, input) {
    ...
    return httpRequest.__asyncGenerator(this, arguments, function paginateListDeadLetterSourceQueues_1() {
        ...
        return httpRequest.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, httpRequest.__await(makePagedRequest$1.apply(void 0, httpRequest.__spreadArray([config.client, input], httpRequest.__read(additionalArguments))))];
                case 2:
                    page = _a.sent();
                    return [3 /*break*/, 6];
                case 3:
                    if (!(config.client instanceof SQSClient)) return [3 /*break*/, 5];
                    return [4 /*yield*/, httpRequest.__await(makePagedClientRequest$1.apply(void 0, httpRequest.__spreadArray([config.client, input], httpRequest.__read(additionalArguments))))];
                case 4:
                    page = _a.sent();
                    return [3 /*break*/, 6];
                case 5: throw new Error("Invalid client, expected SQS | SQSClient");
                case 6: return [4 /*yield*/, httpRequest.__await(page)];
                ...
                case 8:
                    ...
                    hasNext = !!token;
                    return [3 /*break*/, 1];
                case 9: return [4 /*yield*/, httpRequest.__await(undefined)];
                case 10: 
                // @ts-ignore
                return [2 /*return*/, _a.sent()];
            }
...
var makePagedClientRequest = function (client, input) {
    ...
    return httpRequest.__awaiter(void 0, void 0, void 0, function () {
        return httpRequest.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.send.apply(client, httpRequest.__spreadArray([new ListQueuesCommand(input)], httpRequest.__read(args)))];
                case 1: 
                // @ts-ignore
                return [2 /*return*/, _a.sent()];
            }
...
var makePagedRequest = function (client, input) {
    ...
    return httpRequest.__awaiter(void 0, void 0, void 0, function () {
        return httpRequest.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.listQueues.apply(client, httpRequest.__spreadArray([input], httpRequest.__read(args)))];
                case 1: 
                // @ts-ignore
                return [2 /*return*/, _a.sent()];
            }
...
function paginateListQueues(config, input) {
    ...
    return httpRequest.__asyncGenerator(this, arguments, function paginateListQueues_1() {
        var token, hasNext, page;
        return httpRequest.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    input["MaxResults"] = config.pageSize;
                    if (!(config.client instanceof SQS)) return [3 /*break*/, 3];
                    return [4 /*yield*/, httpRequest.__await(makePagedRequest.apply(void 0, httpRequest.__spreadArray([config.client, input], httpRequest.__read(additionalArguments))))];
                case 2:
                    page = _a.sent();
                    return [3 /*break*/, 6];
                case 3:
                    if (!(config.client instanceof SQSClient)) return [3 /*break*/, 5];
                    return [4 /*yield*/, httpRequest.__await(makePagedClientRequest.apply(void 0, httpRequest.__spreadArray([config.client, input], httpRequest.__read(additionalArguments))))];
                case 4:
                    page = _a.sent();
                    return [3 /*break*/, 6];
                case 5: throw new Error("Invalid client, expected SQS | SQSClient");

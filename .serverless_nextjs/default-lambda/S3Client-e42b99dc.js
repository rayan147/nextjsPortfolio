...
var _commonjsHelpers = require('./_commonjsHelpers-429052b6.js');
var Stream = require('stream');
var fs = require('fs');
var configurations = require('./configurations-a8a5ec49.js');
require('http2');
var index = require('./index-b1a90fae.js');
...
var tslib_1 = /*@__PURE__*/_commonjsHelpers.getAugmentedNamespace(tslib_es6);
...
var HeaderMarshaller = /** @class */ (function () {
    ...
    HeaderMarshaller.prototype.format = function (headers) {
        ...
        var chunks = [];
        try {
            for (var _c = httpRequest.__values(Object.keys(headers)), _d = _c.next(); !_d.done; _d = _c.next()) {
        ...
        var position = 0;
        try {
            for (var chunks_1 = httpRequest.__values(chunks), chunks_1_1 = chunks_1.next(); !chunks_1_1.done; chunks_1_1 = chunks_1.next()) {
...
function getChunkedStream(source) {
    ...
    var iterator = function () {
        return httpRequest.__asyncGenerator(this, arguments, function () {
    ...
    return _a = {},
        _a[Symbol.asyncIterator] = function () {
            return httpRequest.__asyncGenerator(this, arguments, function () {
                ...
                var _a, _b;
                var e_1, _c;
                return httpRequest.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            _d.trys.push([0, 12, 13, 18]);
                            source_1 = httpRequest.__asyncValues(source);
                            _d.label = 1;
                        case 1: return [4 /*yield*/, httpRequest.__await(source_1.next())];
                        case 2:
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, httpRequest.__await(options.deserializer(exception))];
                        case 4:
                        ...
                        case 5:
                            ...
                            event = (_b = {},
                                ...
                                _b);
                            return [4 /*yield*/, httpRequest.__await(options.deserializer(event))];
                        case 6:
                            deserialized = _d.sent();
                            if (deserialized.$unknown)
                                return [3 /*break*/, 10];
                            return [4 /*yield*/, httpRequest.__await(deserialized)];
                        ...
                        case 13:
                            ...
                            return [4 /*yield*/, httpRequest.__await(_c.call(source_1))];
                        case 14:
                            _d.sent();
                            _d.label = 15;
                ...
                return httpRequest.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            input_1 = httpRequest.__asyncValues(input);
                            _b.label = 1;
                        case 1: return [4 /*yield*/, httpRequest.__await(input_1.next())];
                        case 2:
                            ...
                            return [4 /*yield*/, httpRequest.__await(payloadBuf)];
                        ...
                        case 8:
                            ...
                            return [4 /*yield*/, httpRequest.__await(_a.call(input_1))];
                        case 9:
                            _b.sent();
                            _b.label = 10;
                        ...
                        case 13: return [4 /*yield*/, httpRequest.__await(new Uint8Array(0))];
                        case 14: 
                        // Ending frame
                        return [4 /*yield*/, _b.sent()];
                        case 15:
...
function readabletoIterable(readStream) {
    return httpRequest.__asyncGenerator(this, arguments, function readabletoIterable_1() {
        ...
        return httpRequest.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, httpRequest.__await(new Promise(function (resolve) { return setTimeout(function () { return resolve(records.shift()); }, 0); }))];
                case 2:
                    value = _a.sent();
                    if (!value) return [3 /*break*/, 5];
                    return [4 /*yield*/, httpRequest.__await(value)];
...
var HashCalculator = /** @class */ (function (_super) {
    httpRequest.__extends(HashCalculator, _super);
...
function resolveBucketEndpointConfig(input) {
    ...
    return httpRequest.__assign(httpRequest.__assign({}, input), { bucketEndpoint: bucketEndpoint,
...
const ClientDefaultValues = {
    ...ClientSharedValues,
    runtime: "node",
    base64Decoder: defaultRoleAssumers.fromBase64,
    base64Encoder: defaultRoleAssumers.toBase64,
    bodyLengthChecker: defaultRoleAssumers.calculateBodyLength,
    credentialDefaultProvider: defaultRoleAssumers.decorateDefaultCredentialProvider(defaultRoleAssumers.defaultProvider),
    defaultUserAgentProvider: defaultRoleAssumers.defaultUserAgent({
        serviceId: ClientSharedValues.serviceId,
        clientVersion: packageInfo.version,
    }),
    eventStreamSerdeProvider,
    maxAttempts: defaultRoleAssumers.loadConfig(configurations.NODE_MAX_ATTEMPT_CONFIG_OPTIONS),
    md5: defaultRoleAssumers.Hash.bind(null, "md5"),
    region: defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_REGION_CONFIG_OPTIONS, defaultRoleAssumers.NODE_REGION_CONFIG_FILE_OPTIONS),
    requestHandler: new defaultRoleAssumers.NodeHttpHandler(),
    retryModeProvider: defaultRoleAssumers.loadConfig(configurations.NODE_RETRY_MODE_CONFIG_OPTIONS),
    sha256: defaultRoleAssumers.Hash.bind(null, "sha256"),
    streamCollector: defaultRoleAssumers.streamCollector,
    streamHasher: fileStreamHasher,
    useArnRegion: defaultRoleAssumers.loadConfig(NODE_USE_ARN_REGION_CONFIG_OPTIONS),
    utf8Decoder: defaultRoleAssumers.fromUtf8,
    utf8Encoder: defaultRoleAssumers.toUtf8,
};

var resolveEventStreamSerdeConfig = function (input) { return (httpRequest.__assign(httpRequest.__assign({}, input), { eventStreamMarshaller: input.eventStreamSerdeProvider(input) })); };
    ...
    return function (next) {
        return function (args) { return httpRequest.__awaiter(_this, void 0, void 0, function () {
            ...
            return httpRequest.__generator(this, function (_a) {
                ...
                if (httpRequest.HttpRequest.isInstance(request) && request.body && options.runtime === "node") {
                    request.headers = httpRequest.__assign(httpRequest.__assign({}, request.headers), { Expect: "100-continue" });
                }
    ...
    return function (next) {
        return function (args) { return httpRequest.__awaiter(_this, void 0, void 0, function () {
            ...
            return httpRequest.__generator(this, function (_a) {
                ...
                return [2 /*return*/, next(httpRequest.__assign({}, args))];
            });
        }); };
    };
}
        ...
        return function (args) { return httpRequest.__awaiter(void 0, void 0, void 0, function () {
            ...
            return httpRequest.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        request = args.request;
                        if (!httpRequest.HttpRequest.isInstance(request) || config.isCustomEndpoint)
                            return [2 /*return*/, next(httpRequest.__assign({}, args))];
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3: return [2 /*return*/, next(httpRequest.__assign({}, args))];
                }
            });
        }); };
    };

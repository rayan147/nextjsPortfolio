...
var constructStack = function () {
    ...
    var expandRelativeMiddlewareList = function (from) {
        ...
        from.before.forEach(function (entry) {
            if (entry.before.length === 0 && entry.after.length === 0) {
                ...
                expandedMiddlewareList.push.apply(expandedMiddlewareList, httpRequest.__spreadArray([], httpRequest.__read(expandRelativeMiddlewareList(entry))));
            }
        });
    ...
    var getMiddlewareList = function () {
        ...
        var mainChain = sort(normalizedAbsoluteEntries)
            ...
            wholeList.push.apply(wholeList, httpRequest.__spreadArray([], httpRequest.__read(expendedMiddlewareList)));
            return wholeList;
        }, []);
...
var StringWrapper = function () {
    ...
    var Constructor = Function.bind.apply(String, httpRequest.__spreadArray([null], httpRequest.__read(arguments)));
...
var __importDefault = (imageHandler.commonjsGlobal && imageHandler.commonjsGlobal.__importDefault) || function (mod) {
...
var decode = imageHandler.createCommonjsModule(function (module, exports) {
var __importDefault = (imageHandler.commonjsGlobal && imageHandler.commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
var encode = imageHandler.createCommonjsModule(function (module, exports) {
var __importDefault = (imageHandler.commonjsGlobal && imageHandler.commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
...
var lib = imageHandler.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

...
require('./image-handler-2dc1bb08.js');
...
var bucketHostname = function (options) {
    ...
    return isBucketNameOptions(options)
        ? // Construct endpoint when bucketName is a string referring to a bucket name
            getEndpointFromBucketName(httpRequest.__assign(httpRequest.__assign({}, options), { isCustomEndpoint: isCustomEndpoint }))
        : // Construct endpoint when bucketName is an ARN referring to an S3 resource like Access Point
            getEndpointFromArn(httpRequest.__assign(httpRequest.__assign({}, options), { isCustomEndpoint: isCustomEndpoint }));
};
...
var getEndpointFromBucketName = function (_a) {
    ...
    var _g = httpRequest.__read(isCustomEndpoint ? [region, baseHostname] : getSuffix(baseHostname), 2), clientRegion = _g[0], hostnameSuffix = _g[1];
            ...
            return httpRequest.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        if (!httpRequest.HttpRequest.isInstance(request)) return [3 /*break*/, 8];
                    ...
                    case 7:
                        ...
                        _g.label = 8;
                    case 8: return [2 /*return*/, next(httpRequest.__assign(httpRequest.__assign({}, args), { request: request }))];
                }
            });
        }); };
    };
...
(function (CompleteMultipartUploadOutput) {
    ...
    CompleteMultipartUploadOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.SSEKMSKeyId && { SSEKMSKeyId: index.SENSITIVE_STRING }),
    });
...
(function (CopyObjectOutput) {
    ...
    CopyObjectOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.SSEKMSKeyId && { SSEKMSKeyId: index.SENSITIVE_STRING }),
        ...(obj.SSEKMSEncryptionContext && { SSEKMSEncryptionContext: index.SENSITIVE_STRING }),
    });
...
(function (CopyObjectRequest) {
    ...
    CopyObjectRequest.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.SSECustomerKey && { SSECustomerKey: index.SENSITIVE_STRING }),
        ...(obj.SSEKMSKeyId && { SSEKMSKeyId: index.SENSITIVE_STRING }),
        ...(obj.SSEKMSEncryptionContext && { SSEKMSEncryptionContext: index.SENSITIVE_STRING }),
        ...(obj.CopySourceSSECustomerKey && { CopySourceSSECustomerKey: index.SENSITIVE_STRING }),
    });
...
(function (ServerSideEncryptionByDefault) {
    ...
    ServerSideEncryptionByDefault.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.KMSMasterKeyID && { KMSMasterKeyID: index.SENSITIVE_STRING }),
    });
...
(function (SSEKMS) {
    ...
    SSEKMS.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.KeyId && { KeyId: index.SENSITIVE_STRING }),
    });
})(SSEKMS || (SSEKMS = {}));
var SSES3;
(function (SSES3) {
...
const serializeAws_restXmlGetObjectCommand = async (input, context) => {
    ...
    if (input.Bucket !== undefined) {
        ...
        resolvedPath = resolvedPath.replace("{Bucket}", index.extendedEncodeURIComponent(labelValue));
    }
    else {
...
const parseBody = (streamBody, context) => collectBodyString(streamBody, context).then((encoded) => {
    if (encoded.length) {
        const parsedObj = index.parser.parse(encoded, {
            attributeNamePrefix: "",
            ignoreAttributes: false,
            parseNodeValue: false,
            trimValues: false,
            tagValueProcessor: (val, tagName) => (val.trim() === "" ? "" : index.lib.decodeHTML(val)),
        });
